...
public class CircularRevealCoordinatorLayout extends CoordinatorLayout implements InterfaceC2496e {

    public final C1381b f6114y;

    public CircularRevealCoordinatorLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f6114y = new C1381b(this);
    }
    ...
    public Drawable getCircularRevealOverlayDrawable() {
        return (Drawable) this.f6114y.f4202f;
    }

    @Override
    public int getCircularRevealScrimColor() {
        return ((Paint) this.f6114y.f4200d).getColor();
    }

    @Override
    public C2495d getRevealInfo() {
        return this.f6114y.m3254d();
    }
