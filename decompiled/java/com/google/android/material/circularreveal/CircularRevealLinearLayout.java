...
public class CircularRevealLinearLayout extends LinearLayout implements InterfaceC2496e {

    public final C1381b f6111a;

    public CircularRevealLinearLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        this.f6111a = new C1381b(this);
    }
    ...
    public Drawable getCircularRevealOverlayDrawable() {
        return (Drawable) this.f6111a.f4202f;
    }

    @Override
    public int getCircularRevealScrimColor() {
        return ((Paint) this.f6111a.f4200d).getColor();
    }

    @Override
    public C2495d getRevealInfo() {
        return this.f6111a.m3254d();
    }
