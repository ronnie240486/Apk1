...
public final class MediaControllerCompat {
    ...
    public static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            public void onReceiveResult(int i6, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    ...
                    mediaControllerImplApi21.mSessionToken.setSession2Token(AbstractC0032a.m152D(bundle));
        ...
        public PlaybackInfo getPlaybackInfo() {
            ...
            if (playbackInfo != null) {
                return new PlaybackInfo(playbackInfo.getPlaybackType(), AudioAttributesCompat.m1529c(playbackInfo.getAudioAttributes()), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume());
            }
            return null;
        }
        ...
        public TransportControls getTransportControls() {
            ...
            return i6 >= 23 ? new TransportControlsApi23(transportControls) : new TransportControlsApi21(transportControls);
        }
    ...
    public static void validateCustomAction(String str, Bundle bundle) {
        ...
        if (str.equals(MediaSessionCompat.ACTION_FOLLOW) || str.equals(MediaSessionCompat.ACTION_UNFOLLOW)) {
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException(AbstractC0004e.m24r("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ", str, "."));
            }
        }
    }
    ...
    public static final class PlaybackInfo {
        ...
        public PlaybackInfo(int i6, int i10, int i11, int i12, int i13) {
            int i14 = AudioAttributesCompat.f2563b;
            C2782c c3029a = Build.VERSION.SDK_INT >= 26 ? new C3029a(11) : new C2782c(11);
            ((AudioAttributes.Builder) c3029a.f9501b).setLegacyStreamType(i10);
            this(i6, new AudioAttributesCompat(c3029a.mo5758q()), i11, i12, i13);
        }
        ...
        public int getAudioStream() {
            return this.mAudioAttrsCompat.f2564a.mo1530a();
        }
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        public static class MediaControllerCallbackApi21 extends MediaController.Callback {
            ...
            public void onAudioInfoChanged(MediaController.PlaybackInfo playbackInfo) {
                ...
                if (callback != null) {
                    callback.onAudioInfoChanged(new PlaybackInfo(playbackInfo.getPlaybackType(), AudioAttributesCompat.m1529c(playbackInfo.getAudioAttributes()), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume()));
                }
            }
