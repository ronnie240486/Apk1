...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final C3341e METADATA_KEYS_TYPE;
    ...
    static {
        ...
        METADATA_KEYS_TYPE = c3341e;
        c3341e.put(METADATA_KEY_TITLE, 1);
        c3341e.put(METADATA_KEY_ARTIST, 1);
        c3341e.put(METADATA_KEY_DURATION, 0);
        c3341e.put(METADATA_KEY_ALBUM, 1);
        c3341e.put(METADATA_KEY_AUTHOR, 1);
        c3341e.put(METADATA_KEY_WRITER, 1);
        c3341e.put(METADATA_KEY_COMPOSER, 1);
        c3341e.put(METADATA_KEY_COMPILATION, 1);
        c3341e.put(METADATA_KEY_DATE, 1);
        c3341e.put(METADATA_KEY_YEAR, 0);
        c3341e.put(METADATA_KEY_GENRE, 1);
        c3341e.put(METADATA_KEY_TRACK_NUMBER, 0);
        c3341e.put(METADATA_KEY_NUM_TRACKS, 0);
        c3341e.put(METADATA_KEY_DISC_NUMBER, 0);
        c3341e.put(METADATA_KEY_ALBUM_ARTIST, 1);
        c3341e.put(METADATA_KEY_ART, 2);
        c3341e.put(METADATA_KEY_ART_URI, 1);
        c3341e.put(METADATA_KEY_ALBUM_ART, 2);
        c3341e.put(METADATA_KEY_ALBUM_ART_URI, 1);
        c3341e.put(METADATA_KEY_USER_RATING, 3);
        c3341e.put(METADATA_KEY_RATING, 3);
        c3341e.put(METADATA_KEY_DISPLAY_TITLE, 1);
        c3341e.put(METADATA_KEY_DISPLAY_SUBTITLE, 1);
        c3341e.put(METADATA_KEY_DISPLAY_DESCRIPTION, 1);
        c3341e.put(METADATA_KEY_DISPLAY_ICON, 2);
        c3341e.put(METADATA_KEY_DISPLAY_ICON_URI, 1);
        c3341e.put(METADATA_KEY_MEDIA_ID, 1);
        c3341e.put(METADATA_KEY_BT_FOLDER_TYPE, 0);
        c3341e.put(METADATA_KEY_MEDIA_URI, 1);
        c3341e.put(METADATA_KEY_ADVERTISEMENT, 0);
        c3341e.put(METADATA_KEY_DOWNLOAD_STATUS, 0);
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            C3341e c3341e = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (c3341e.containsKey(str) && ((Integer) c3341e.get(str)).intValue() != 2) {
                throw new IllegalArgumentException(AbstractC0004e.m24r("The ", str, " key cannot be used to put a Bitmap"));
            }
        ...
        public Builder putLong(String str, long j10) {
            C3341e c3341e = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (c3341e.containsKey(str) && ((Integer) c3341e.get(str)).intValue() != 0) {
                throw new IllegalArgumentException(AbstractC0004e.m24r("The ", str, " key cannot be used to put a long"));
            }
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            C3341e c3341e = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (c3341e.containsKey(str) && ((Integer) c3341e.get(str)).intValue() != 3) {
                throw new IllegalArgumentException(AbstractC0004e.m24r("The ", str, " key cannot be used to put a Rating"));
            }
        ...
        public Builder putString(String str, String str2) {
            C3341e c3341e = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (c3341e.containsKey(str) && ((Integer) c3341e.get(str)).intValue() != 1) {
                throw new IllegalArgumentException(AbstractC0004e.m24r("The ", str, " key cannot be used to put a String"));
            }
        ...
        public Builder putText(String str, CharSequence charSequence) {
            C3341e c3341e = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (c3341e.containsKey(str) && ((Integer) c3341e.get(str)).intValue() != 1) {
                throw new IllegalArgumentException(AbstractC0004e.m24r("The ", str, " key cannot be used to put a CharSequence"));
            }
