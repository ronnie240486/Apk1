...
public final class C3049u extends VolumeProvider {

    public final AbstractC3052x f10405a;

    public C3049u(AbstractC3052x abstractC3052x, int i6, int i10, int i11) {
        super(i6, i10, i11);
        this.f10405a = abstractC3052x;
    }

    @Override
    public final void onAdjustVolume(int i6) {
        C3399d c3399d = (C3399d) this.f10405a;
