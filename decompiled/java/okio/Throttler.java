...
public final class Throttler {
    ...
    public static void bytesPerSecond$default(Throttler throttler, long j10, long j11, long j12, int i6, Object obj) {
        if ((i6 & 2) != 0) {
    ...
    private final long bytesToNanos(long j10) {
        return (j10 * C0565C.NANOS_PER_SECOND) / this.bytesPerSecond;
    }

    private final long nanosToBytes(long j10) {
        return (j10 * this.bytesPerSecond) / C0565C.NANOS_PER_SECOND;
    }
