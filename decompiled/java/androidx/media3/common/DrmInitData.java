    ...
    public static final class SchemeData implements Parcelable {
        ...
        public int hashCode() {
            if (this.hashCode == 0) {
                ...
                this.hashCode = Arrays.hashCode(this.data) + AbstractC0004e.m14h((iHashCode + (str == null ? 0 : str.hashCode())) * 31, 31, this.mimeType);
            }
            return this.hashCode;
        }

        public boolean matches(UUID uuid) {
            return C0565C.UUID_NIL.equals(this.uuid) || uuid.equals(this.uuid);
        }
