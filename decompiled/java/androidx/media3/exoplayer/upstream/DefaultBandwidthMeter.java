...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public synchronized void onBytesTransferred(DataSource dataSource, DataSpec dataSpec, boolean z7, int i6) {
        if (isTransferAtFullNetworkSpeed(dataSpec, z7)) {
            this.sampleBytesTransferred += (long) i6;
        }
    }
    ...
    public synchronized void onTransferEnd(DataSource dataSource, DataSpec dataSpec, boolean z7) {
        try {
            if (isTransferAtFullNetworkSpeed(dataSpec, z7)) {
                ...
                this.totalElapsedTimeMs += (long) i6;
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            map.put(0, 1000000L);
            map.put(2, Long.valueOf(C0565C.TIME_UNSET));
            map.put(3, Long.valueOf(C0565C.TIME_UNSET));
            map.put(4, Long.valueOf(C0565C.TIME_UNSET));
            map.put(5, Long.valueOf(C0565C.TIME_UNSET));
            map.put(10, Long.valueOf(C0565C.TIME_UNSET));
            map.put(9, Long.valueOf(C0565C.TIME_UNSET));
            map.put(7, Long.valueOf(C0565C.TIME_UNSET));
        }
        ...
        public Builder setInitialBitrateEstimate(String str) {
            ...
            for (Integer num : this.initialBitrateEstimates.keySet()) {
                setInitialBitrateEstimate(num.intValue(), DefaultBandwidthMeter.getInitialBitrateEstimatesForCountry(strM3233x, num.intValue()));
            }
            return this;
        }
    }
    ...
    private DefaultBandwidthMeter(Context context, Map<Integer, Long> map, int i6, Clock clock, boolean z7) {
        ...
        networkTypeObserver.register(new C0962f(0, this), BackgroundExecutor.get());
    }
