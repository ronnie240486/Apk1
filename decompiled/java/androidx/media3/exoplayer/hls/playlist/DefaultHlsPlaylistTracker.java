...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    public static final HlsPlaylistTracker.Factory FACTORY = new C0788a();
    ...
    public final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
        ...
        private Uri getMediaPlaylistUriForReload() {
            ...
            if (hlsMediaPlaylist != null) {
                ...
                if (serverControl.skipUntilUs != C0565C.TIME_UNSET || serverControl.canBlockReload) {
                    ...
                    if (hlsMediaPlaylist2.serverControl.canBlockReload) {
                        ...
                        if (hlsMediaPlaylist3.partTargetDurationUs != C0565C.TIME_UNSET) {
                            List<HlsMediaPlaylist.Part> list = hlsMediaPlaylist3.trailingParts;
                            int size = list.size();
                            if (!list.isEmpty() && ((HlsMediaPlaylist.Part) AbstractC2182d0.m5151n(list)).isPreload) {
                                size--;
                            }
                    ...
                    if (serverControl2.skipUntilUs != C0565C.TIME_UNSET) {
        ...
        public void lambda$loadPlaylistInternal$0(Uri uri) {
        ...
        public void loadPlaylistInternal(final Uri uri) {
            ...
            if (jElapsedRealtime >= this.earliestNextLoadTimeMs) {
                ...
                DefaultHlsPlaylistTracker.this.playlistRefreshHandler.postDelayed(new Runnable() {
                    @Override
                    public final void run() {
                        this.f2878a.lambda$loadPlaylistInternal$0(uri);
                    }
        ...
        public void processLoadedPlaylist(HlsMediaPlaylist hlsMediaPlaylist, LoadEventInfo loadEventInfo) {
            ...
            if (hlsMediaPlaylist4.serverControl.canBlockReload) {
                ...
                j10 = hlsMediaPlaylist4 != hlsMediaPlaylist2 ? hlsMediaPlaylist4.targetDurationUs : hlsMediaPlaylist4.targetDurationUs / 2;
            }
    ...
    public void stop() {
        ...
        this.initialStartTimeUs = C0565C.TIME_UNSET;
    ...
    public Loader.LoadErrorAction onLoadError(ParsingLoadable<HlsPlaylist> parsingLoadable, long j10, long j11, IOException iOException, int i6) {
        ...
        boolean z7 = retryDelayMsFor == C0565C.TIME_UNSET;
