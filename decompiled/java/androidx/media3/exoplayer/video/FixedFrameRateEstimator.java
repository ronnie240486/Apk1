...
final class FixedFrameRateEstimator {
    ...
    private long lastFramePresentationTimeNs = C0565C.TIME_UNSET;
    ...
    public long getFrameDurationNs() {
        return isSynced() ? this.currentMatcher.getFrameDurationNs() : C0565C.TIME_UNSET;
    }
    ...
    public long getMatchingFrameDurationSumNs() {
        return isSynced() ? this.currentMatcher.getMatchingFrameDurationSumNs() : C0565C.TIME_UNSET;
    }
    ...
    public void onNextFrame(long j10) {
        ...
        } else if (this.lastFramePresentationTimeNs != C0565C.TIME_UNSET) {
    ...
    public void reset() {
        ...
        this.candidateMatcher.reset();
        this.candidateMatcherActive = false;
        this.lastFramePresentationTimeNs = C0565C.TIME_UNSET;
