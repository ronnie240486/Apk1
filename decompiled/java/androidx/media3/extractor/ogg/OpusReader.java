...
final class OpusReader extends StreamReader {
    ...
    public boolean readHeaders(ParsableByteArray parsableByteArray, long j10, StreamReader.SetupData setupData) throws ParserException {
        ...
        Metadata vorbisComments = VorbisUtil.parseVorbisComments(AbstractC2301u1.m5273o(VorbisUtil.readVorbisCommentHeader(parsableByteArray, false, false).comments));
