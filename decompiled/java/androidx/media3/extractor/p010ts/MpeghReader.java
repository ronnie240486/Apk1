...
public final class MpeghReader implements ElementaryStreamReader {
    ...
    private int samplingRate = C0565C.RATE_UNSET_INT;
    ...
    private void parseConfig(ParsableBitArray parsableBitArray) throws ParserException {
        ...
        if (j10 != j11) {
            ...
            this.output.format(new Format.Builder().setId(this.formatId).setContainerMimeType(this.containerMimeType).setSampleMimeType(MimeTypes.AUDIO_MPEGH_MHM1).setSampleRate(this.samplingRate).setCodecs(strConcat).setInitializationData((bArr == null || bArr.length <= 0) ? null : AbstractC2301u1.m5276s(Util.EMPTY_BYTE_ARRAY, bArr)).build());
        }
    ...
    public void seek() {
        ...
        this.payloadBytesRead = 0;
        this.frameBytes = 0;
        this.samplingRate = C0565C.RATE_UNSET_INT;
