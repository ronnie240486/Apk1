...
final class PsDurationReader {
    ...
    private long firstScrValue = C0565C.TIME_UNSET;
    private long lastScrValue = C0565C.TIME_UNSET;
    ...
    public static long readScrValueFromPack(ParsableByteArray parsableByteArray) {
        ...
        return !checkMarkerBits(bArr) ? C0565C.TIME_UNSET : readScrValueFromPackHeader(bArr);
    }

    private static long readScrValueFromPackHeader(byte[] bArr) {
        byte b8 = bArr[0];
        long j10 = (((((long) b8) & 56) >> 3) << 30) | ((((long) b8) & 3) << 28) | ((((long) bArr[1]) & 255) << 20);
        byte b10 = bArr[2];
        return j10 | (((((long) b10) & 248) >> 3) << 15) | ((((long) b10) & 3) << 13) | ((((long) bArr[3]) & 255) << 5) | ((((long) bArr[4]) & 248) >> 3);
    }
    ...
    public int readDuration(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        if (this.lastScrValue == C0565C.TIME_UNSET) {
