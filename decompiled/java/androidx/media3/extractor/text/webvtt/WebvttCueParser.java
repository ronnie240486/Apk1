...
public final class WebvttCueParser {
    ...
    public static class Element {
        private static final Comparator<Element> BY_START_POSITION_ASC = new C1033a(0);
        private final int endPosition;
        private final StartTag startTag;

        public static int lambda$static$0(Element element, Element element2) {
    ...
    public static final class WebvttCueInfoBuilder {
        ...
        private static float computeLine(float f, int i6) {
            ...
            return i6 == 0 ? 1.0f : -3.4028235E38f;
        }
        ...
        private static Layout.Alignment convertTextAlignment(int i6) {
            if (i6 != 1) {
                ...
                if (i6 != 3) {
                    if (i6 != 4) {
                        if (i6 != 5) {
                            AbstractC0004e.m31y(i6, "Unknown textAlignment: ", WebvttCueParser.TAG);
                            return null;
                        }
                    }
                }
    ...
    private static void applyEntity(String str, SpannableStringBuilder spannableStringBuilder) {
        ...
        switch (str) {
            ...
            case "nbsp":
                ...
                break;
            default:
                Log.m1719w(TAG, "ignoring unsupported entity: '&" + str + ";'");
                break;
        }
    }
    ...
    private static int parseLineAnchor(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 0;
            default:
                Log.m1719w(TAG, "Invalid anchor value: ".concat(str));
    ...
    private static int parseTextAlignment(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 1;
            default:
                Log.m1719w(TAG, "Invalid alignment value: ".concat(str));
                return 2;
        }
    }
    ...
    private static int parseVerticalAttribute(String str) {
        ...
        Log.m1719w(TAG, "Invalid 'vertical' value: ".concat(str));
        return Integer.MIN_VALUE;
    }
        ...
        while (matcher.find()) {
            ...
            try {
                if ("line".equals(str2)) {
                    ...
                    Log.m1719w(TAG, "Unknown cue setting " + str2 + ":" + str3);
                }
            } catch (NumberFormatException unused) {
                Log.m1719w(TAG, "Skipping bad cue setting: " + matcher.group());
            }
        }
    }
    ...
    private static WebvttCueInfo parseCue(String str, Matcher matcher, ParsableByteArray parsableByteArray, List<WebvttCssStyle> list) {
        ...
        try {
            ...
            Log.m1719w(TAG, "Skipping cue with bad header: " + matcher.group());
            return null;
        }
    }
}
