...
public final class AviExtractor implements Extractor {
    ...
    private void parseHdrlBody(ParsableByteArray parsableByteArray) throws IOException {
        ...
        C2204g1 c2204g1ListIterator = from.children.listIterator(0);
        int i6 = 0;
        while (c2204g1ListIterator.hasNext()) {
            AviChunk aviChunk = (AviChunk) c2204g1ListIterator.next();
    ...
    private ChunkReader processStreamList(ListChunk listChunk, int i6) {
        ...
        if (aviStreamHeaderChunk == null) {
            Log.m1719w(TAG, "Missing Stream Header");
            return null;
        }
        if (streamFormatChunk == null) {
            Log.m1719w(TAG, "Missing Stream Format");
            return null;
        }
