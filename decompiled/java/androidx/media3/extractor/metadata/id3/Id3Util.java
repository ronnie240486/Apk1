...
public final class Id3Util {
    private static final AbstractC2301u1 STANDARD_GENRES;
    ...
    static {
        ...
        AbstractC2182d0.m5139b(objArr, 192);
        STANDARD_GENRES = AbstractC2301u1.m5268j(objArr, 192);
    }
    ...
    public static String resolveV1Genre(int i6) {
        if (i6 >= 0) {
            AbstractC2301u1 abstractC2301u1 = STANDARD_GENRES;
            if (i6 < abstractC2301u1.size()) {
                return (String) abstractC2301u1.get(i6);
            }
        }
        return null;
    }
