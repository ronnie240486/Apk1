...
final class Utils {
    ...
    public static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public String toString() {
            return AbstractC0004e.m26t(new StringBuilder(), Utils.typeToString(this.componentType), HttpUrl.PATH_SEGMENT_ENCODE_SET_URI);
        }
    }
    ...
    public static Type getParameterUpperBound(int i6, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbM27u = AbstractC0004e.m27u(i6, "Index ", " not in range [0,");
        sbM27u.append(actualTypeArguments.length);
        sbM27u.append(") for ");
        sbM27u.append(parameterizedType);
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i6, String str, Object... objArr) {
        StringBuilder sbM29w = AbstractC0004e.m29w(str, " (parameter #");
        sbM29w.append(i6 + 1);
        sbM29w.append(")");
        return methodError(method, th, sbM29w.toString(), objArr);
    }
    ...
    public static RuntimeException methodError(Method method, Throwable th, String str, Object... objArr) {
        StringBuilder sbM29w = AbstractC0004e.m29w(String.format(str, objArr), "\n    for method ");
        sbM29w.append(method.getDeclaringClass().getSimpleName());
        sbM29w.append(".");
        sbM29w.append(method.getName());
        return new IllegalArgumentException(sbM29w.toString(), th);
    }
    ...
    public static RuntimeException parameterError(Method method, int i6, String str, Object... objArr) {
        ...
        sbM29w.append(i6 + 1);
        sbM29w.append(")");
        return methodError(method, sbM29w.toString(), objArr);
    }
}
