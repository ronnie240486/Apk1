...
final class RequestBuilder {
    ...
    public void addHeader(String str, String str2) {
        ...
        try {
            ...
            throw new IllegalArgumentException(AbstractC2460q.m5501o("Malformed content type: ", str2), e5);
        }
    }
    ...
    public void addPathParam(String str, String str2, boolean z7) throws EOFException {
        ...
        if (PATH_TRAVERSAL.matcher(strReplace).matches()) {
            throw new IllegalArgumentException(AbstractC2460q.m5501o("@Path parameters shouldn't perform path traversal ('.' or '..'): ", str2));
        }
