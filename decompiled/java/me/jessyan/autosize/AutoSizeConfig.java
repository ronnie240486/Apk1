...
public final class AutoSizeConfig {
    ...
    public AutoSizeConfig init(final Application application, boolean z7, AutoAdaptStrategy autoAdaptStrategy) {
        ...
        AutoSizeLog.m6118d("designWidthInDp = " + this.mDesignWidthInDp + ", designHeightInDp = " + this.mDesignHeightInDp + ", screenWidth = " + this.mScreenWidth + ", screenHeight = " + this.mScreenHeight);
            ...
            public void onConfigurationChanged(Configuration configuration2) {
                if (configuration2 != null) {
                    if (configuration2.fontScale > 0.0f) {
                        ...
                        AutoSizeLog.m6118d("initScaledDensity = " + AutoSizeConfig.this.mInitScaledDensity + " on ConfigurationChanged");
                    }
        ...
        AutoSizeLog.m6118d("initDensity = " + this.mInitDensity + ", initScaledDensity = " + this.mInitScaledDensity);
