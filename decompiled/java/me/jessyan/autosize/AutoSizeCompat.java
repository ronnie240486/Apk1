...
public final class AutoSizeCompat {
    ...
    public static void cancelAdapt(Resources resources) {
        ...
        int i6 = C30931.$SwitchMap$me$jessyan$autosize$unit$Subunits[AutoSizeConfig.getInstance().getUnitsManager().getSupportSubunits().ordinal()];
        if (i6 != 1) {
            f = i6 == 2 ? 25.4f : 72.0f;
    ...
    private static void setDensity(DisplayMetrics displayMetrics, float f, int i6, float f3, float f4) {
        ...
        int i10 = C30931.$SwitchMap$me$jessyan$autosize$unit$Subunits[AutoSizeConfig.getInstance().getUnitsManager().getSupportSubunits().ordinal()];
        if (i10 == 1) {
