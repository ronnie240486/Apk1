...
public final class CacheInterceptor implements Interceptor {
    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers headers, Headers headers2) {
            ...
            for (int i6 = 0; i6 < size; i6++) {
                ...
                if ((!"Warning".equalsIgnoreCase(strName) || !AbstractC3656n.m7404V(strValue, IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE, false)) && (isContentSpecificHeader(strName) || !isEndToEnd(strName) || headers2.get(strName) == null)) {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (networkRequest == null) {
            AbstractC2796i.m5782c(cacheResponse);
        ...
        try {
            ...
            if (cacheResponse != null) {
                if (responseProceed != null && responseProceed.code() == 304) {
                    ...
                    AbstractC2796i.m5782c(responseBodyBody4);
                    responseBodyBody4.close();
                    Cache cache3 = this.cache;
                    AbstractC2796i.m5782c(cache3);
            ...
            AbstractC2796i.m5782c(responseProceed);
